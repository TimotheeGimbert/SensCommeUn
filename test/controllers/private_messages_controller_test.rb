...
class PrivateMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create private_message" do
    assert_difference('PrivateMessage.count') do
      post private_messages_url, params: { private_message: { author_id: @private_message.author_id, author_type: @private_message.author_type, content: @private_message.content, object: @private_message.object } }
    end
  ...
  test "should update private_message" do
    patch private_message_url(@private_message), params: { private_message: { author_id: @private_message.author_id, author_type: @private_message.author_type, content: @private_message.content, object: @private_message.object } }
